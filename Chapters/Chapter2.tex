...
features is illustrated by the simple experiment of adding vast
quantities of adversarially perturbed data during training
~\cite{adversarial-training}. Although this method increases
adversarial robustness, it does not do so very significantly, and
leaves behind vulnerabilities that can still be reduced to non-robust
features ~\cite{adversarial-training-vulnerability}. 
